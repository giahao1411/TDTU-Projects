...
class MyDoubleLinkedList<E> implements DoubleListInterface<E> {
    private DoubleNode<E> head = null;
    private DoubleNode<E> prev = null;
    ...
    public void addFirst(E item) {
        if (head != null) {
            DoubleNode<E> n = head;
            head = new DoubleNode<E>(item, null, head);
            prev = head;
            n.setPrev(prev);
        } else
            head = new DoubleNode<E>(item, null, head);
    ...
    public boolean contains(E item) {
        for (DoubleNode<E> n = head; n != null; n = n.getNext()) {
    ...
    @Override
    public E removeAfter(DoubleNode<E> curr) throws NoSuchElementException {
        if (curr != null) {
            DoubleNode<E> delNode = curr.getNext();
            if (delNode != null) {
